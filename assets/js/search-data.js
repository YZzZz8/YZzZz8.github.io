...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-恭喜课题组成员张梦霞的研究论文-bdpackets-a-clean-label-backdoor-attack-on-network-traffic-classifiers-via-feature-fusion-成功被ccf-a类会议ieee-infocom-2026录用-该成果为网络流量分类模型安全防护提供了新视角",
          title: '恭喜课题组成员张梦霞的研究论文《BDpackets: A Clean-label Backdoor Attack on Network Traffic Classifiers via Feature Fusion》成功被CCF A类会议IEEE...',
          description: "",
          section: "News",},{id: "news-恭喜课题组成员胥迤潇的论文-at-field-rethinking-the-games-in-adversarial-training-被被ccf-a类会议aaai-2026录用-并受邀作口头报告-录用率仅17-6-口头报告率小于5-该成果为对抗训练领域研究作出了积极贡献",
          title: '恭喜课题组成员胥迤潇的论文《AT-Field: Rethinking the Games in Adversarial Training》被被CCF A类会议AAAI 2026录用，并受邀作口头报告（录用率仅17.6%，口头报告率小于5%），该成果为对抗训练领域研究作出了积极贡献。🎉🎉🎉',
          description: "",
