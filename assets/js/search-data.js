...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-研究组负责人李默涵作为核心作者参与的论文-towards-robust-and-secure-embodied-ai-a-survey-on-vulnerabilities-and-attacks-正式发表于acm-computing-surveys-该刊在jcr和中科院分区中均保持q1区top期刊地位-该成果系统梳理具身智能安全漏洞与攻击范式-为构建安全可信的具身智能系统提供重要研究框架",
          title: '研究组负责人李默涵作为核心作者参与的论文《Towards Robust and Secure Embodied AI: A Survey on Vulnerabilities and Attacks》正式发表于ACM Computing...',
          description: "",
