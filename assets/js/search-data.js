...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-研究组成员胥迤潇的论文-neural-honeytrace-plug-amp-amp-play-watermarking-framework-against-model-extraction-attacks-被ccf-a类会议icml-2026接受-该成果提出了神经蜜洞-将四蜜思想引入模型产权保护领域-利用后门长尾效应设计了即插即用-无需重训练的模型水印-在模型知识产权保护-抵御模型窃取攻击领域作出了积极贡献",
          title: '研究组成员胥迤潇的论文《Neural Honeytrace:Plug&amp;amp;amp;Play Watermarking Framework against Model Extraction Attacks》被CCF A类会议ICML 2026接受，该成果提出了神经蜜洞，将四蜜思想引入模型产权保护领域，利用后门长尾效应设计了即插即用、无需重训练的模型水印，在模型知识产权保护、抵御模型窃取攻击领域作出了积极贡献。🎉🎉🎉',
          description: "",
